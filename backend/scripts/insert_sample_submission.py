...
# ---------------------------------------------------------------------------
# source_audio = Path(__file__).parent.parent / "data" / "cactus.m4a"
# if not source_audio.exists():
#     raise SystemExit("Sample audio data/cactus.m4a not found.")
...
#     "answer_type": "audio",
#     "file_path": f"uploads/{dest_name_audio}",
# })
# diagram_idx += 1
...
# ---------------------------------------------------------------------------
source_image = Path(__file__).parent.parent / "preprocessing" / "braille_aug.png"
...
answers.append({
        "diagram_idx": diagram_idx,
        "answer_type": "image",
        "file_path": f"uploads/{dest_name_image}",
    })
diagram_idx += 1
